...
<!-- GENERATED by sync_docs (curated translation of mnemos-mesh@331ef3a785c1) from viewer/src/features/docs/curated/mnemos-mesh/ru/user/configuration.md — правки в curated-файле, не здесь -->
