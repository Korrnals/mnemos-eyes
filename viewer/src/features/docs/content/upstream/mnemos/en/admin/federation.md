---
title: Federation — Phase 1 prerequisites (per-peer ACL + trigger codes + access log)
...
> Curator: federation on the Mnemos side — per-peer ACL, trigger codes, access log; the foundation of the observed mesh nodes.
...
[`federation-testing.md`](https://github.com/vesmaro/vesmaro/blob/23f0fce42ea87c329d4049397292b3dca948773c/docs/en/admin/federation-testing.md). The original rollout
...
- [ADR-0016 — Federation threat model](https://github.com/vesmaro/vesmaro/blob/23f0fce42ea87c329d4049397292b3dca948773c/docs/project/adr/0016-federation-threat-model.md)
- [Security — Federation defence-in-depth](mnemos/admin/security#11-federation-defence-in-depth)
- [Federation — Batch Sync (Phase 0)](mnemos/user/sync)
