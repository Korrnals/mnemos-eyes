...
> Curator: installing Mnemos — the board's prerequisite: PyPI install, first run, the mnk_… token for the store hookup.
...
[`integrations/mcp-presets.md`](https://github.com/vesmaro/vesmaro/blob/23f0fce42ea87c329d4049397292b3dca948773c/integrations/mcp-presets.md). Behavioral pack (instructions
...
[container-deployment.md](https://github.com/vesmaro/vesmaro/blob/23f0fce42ea87c329d4049397292b3dca948773c/docs/en/admin/runbooks/container-deployment.md).
...
`~/.mnemos/data/` before major upgrades — see [backup-restore.md](mnemos/admin/runbooks/backup-restore).
