...
slug: mnemos/user/integration-guide
...
> Куратор: поведенческие триггеры, которые заставляют агентов реально пользоваться памятью, — recall в начале сессии, чекпоинты, обязательные теги.
...
конфигурацией — в [context-filter.md](mnemos/user/context-filter).
...
- **Хуки жизненного цикла** — групповой MCP-инструмент `mnemos_hooks` и
  ...
  / [http-api.md → Хуки жизненного цикла](mnemos/user/http-api).
...
аудита конвейера знаний — см. [контекстный фильтр](mnemos/user/context-filter) и
[обзор архитектуры](mnemos/architecture/overview) для стадий пайплайна.
...
Для VS Code Copilot Chat см. [getting-started.md](mnemos/user/getting-started#подключите-ваш-харнес-mcp)
...
и настройку env): [`integrations/mcp-presets.md`](https://github.com/vesmaro/vesmaro/blob/23f0fce42ea87c329d4049397292b3dca948773c/integrations/mcp-presets.md).
...
[`integrations/adapter-template.md`](https://github.com/vesmaro/vesmaro/blob/23f0fce42ea87c329d4049397292b3dca948773c/integrations/adapter-template.md):
...
Полная схема — в [tag-contract.md](mnemos/user/tag-contract). Слой интеграции
