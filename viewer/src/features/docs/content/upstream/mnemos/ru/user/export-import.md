...
slug: mnemos/user/export-import
...
> Куратор: резервные копии и перенос записей mnemos через CLI или HTTP API — JSON с метаданными или полные SQLite-снимки.
...
- [Справочник HTTP API](mnemos/user/http-api) — все эндпоинты.
- [Модель безопасности](mnemos/admin/security) — шифрование, гигиена секретов.
