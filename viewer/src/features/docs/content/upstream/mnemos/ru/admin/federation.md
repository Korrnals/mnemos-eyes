---
title: Федерация — предпосылки Phase 1 (per-peer ACL + триггер-коды + журнал доступа)
slug: mnemos/admin/federation
...
> Куратор: федерация на стороне mnemos — per-peer ACL, коды триггера, журнал доступа; фундамент наблюдаемых «Узлов меша».
...
[`federation-testing.md`](https://github.com/vesmaro/vesmaro/blob/23f0fce42ea87c329d4049397292b3dca948773c/docs/ru/admin/federation-testing.md). Изначально внедрение
...
- [ADR-0016 — модель угроз федерации](https://github.com/vesmaro/vesmaro/blob/23f0fce42ea87c329d4049397292b3dca948773c/docs/project/adr/0016-federation-threat-model.md)
- [Security — Federation defence-in-depth](mnemos/admin/security#11-federation-defence-in-depth)
- [Федерация — пакетная синхронизация (Phase 0)](mnemos/user/sync)
