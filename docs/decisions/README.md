...
| [0013](0013-scheduler-hooks-automation.md) | Scheduler & hooks — launch automation as a separate domain (SCHED-1, variant C) | Accepted by committee — pending owner ratification |
